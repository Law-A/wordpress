    ...
    <div class="inner-cont">
	    ...
	    <div class="tab-sec">
	    	<div class="tab">
				...
				<button class="tablinks" onclick="fitness_elementor_open_tab(event, 'wpelemento_importer_editor')"><?php esc_html_e( 'Demo Import', 'fitness-elementor' ); ?></button>
			...
			<div id="wpelemento_importer_editor" class="tabcontent">
				...
				<?php }else{ ?>
					<div class="tab-outer-box">
						<h2><?php esc_html_e( 'Welcome to Elemento Theme!', 'fitness-elementor' ); ?></h2>
						<p><?php esc_html_e( 'For setup the theme, First you need to click on the Begin activating plugins', 'fitness-elementor' ); ?></p>
						<p><?php esc_html_e( '1. Install Kirki Customizer Framework ', 'fitness-elementor' ); ?></p>
						<p><?php esc_html_e( '>> Then click to Return to Required Plugins Installer ', 'fitness-elementor' ); ?></p>
						<p><?php esc_html_e( '2. Install WPElemento Importer', 'fitness-elementor' ); ?></p>
						<p><?php esc_html_e( '>> Then click to Return to Required Plugins Installer ', 'fitness-elementor' ); ?></p>
						<p><?php esc_html_e( '3. Activate Kirki Customizer Framework ', 'fitness-elementor' ); ?></p>
						<p><?php esc_html_e( '4. Activate WPElemento Importer ', 'fitness-elementor' ); ?></p>
						<p><?php esc_html_e( '>> Then click to Return to the Dashboard', 'fitness-elementor' ); ?></p>
						<p><?php esc_html_e( '>> Click on the start now button', 'fitness-elementor' ); ?></p>
						<p><?php esc_html_e( '>> Click install plugins', 'fitness-elementor' ); ?></p>
						<p><?php esc_html_e( '>> Click import demo button to setup the theme and click visit your site button', 'fitness-elementor' ); ?></p>
					</div>
				<?php } ?>
			</div>
		...
		<div class="inner-side-content">
			...
			<div class="tab-outer-box">
				...
				<div class="iner-sidebar-pro-btn">
					<span class="premium-btn"><a href="<?php echo esc_url( FITNESS_ELEMENTOR_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Buy Now', 'fitness-elementor'); ?></a>
					</span>
					...
					<span class="doc-btn"><a href="<?php echo esc_url( FITNESS_ELEMENTOR_PRO_DOC ); ?>" target="_blank"><?php esc_html_e('Pro Doc', 'fitness-elementor'); ?></a>
					</span>
				</div>
				<hr>
